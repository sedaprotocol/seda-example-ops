...
import { createSuccessfulBigIntArrayReveal, createSuccessfulBigIntReveal } from './utils.js';
...
describe('create successful reveal', () => {
  it('uint256 array should encode a reveal with two values', () => {
    ...
    const reveal = createSuccessfulBigIntArrayReveal([118057000000n, 3783400000n]);
  ...
  it('uint256 should encode a reveal with one value', () => {
    ...
    const reveal = createSuccessfulBigIntReveal(100n);
